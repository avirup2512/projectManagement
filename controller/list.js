...
var listController = (function () {
    ...
    bolistard.prototype.checkUserIsAuthenticated = async function (boardId,userId) {
    ...
    list.prototype.checkBoardExists = async function (boardId) {
    ...
    list.prototype.checkRole = function (role) {
        let response = {};
    ...
    list.prototype.editBoard = async function (param)
    {
        var self = this;
        let res = new response();
    ...
    list.prototype.deleteBoard = async function (param)
    {
        var self = this;
        let res = new response();
        let {boardId} = param;
    ...
    list.prototype.getAllBoard = async function (param)
    {
         let res = new response();
        let { userId } = param;        
